...
export function Projects() {
  ...
  const projects = t.projects.items.map((item, i) => ({
    ...item,
    tags: i === 0 ? ['Next.js', 'Tailwind CSS', 'Framer Motion'] : i === 1 ? ['React', 'TypeScript', 'Stripe'] : ['Vite', 'React', 'OpenAI API'],
    ...
    <section id="projects" className="py-24 bg-bg">
      <div className="container mx-auto px-6">
        ...
        >
            ...
            <a href="#" className="hidden md:flex items-center gap-2 text-accent hover:text-accent-strong font-mono transition-colors group">
              {t.projects.viewAll}
          ...
          {projects.map((project, i) => (
            <motion.div
              ...
              className={cn(
                ...
                'hover:border-accent/30 hover:shadow-[0_0_30px_var(--color-glow)]'
              )}
            >
              <div className="flex justify-between items-start mb-8 text-muted group-hover:text-accent transition-colors">
                ...
                <div className="flex gap-4">
                  <a href={project.github} className="hover:text-heading transition-colors" aria-label="Github">
                    <GithubIcon size={20} />
                  </a>
                  <a href={project.link} className="hover:text-heading transition-colors" aria-label="Live link">
